...
**Falsifier:** an industry-level price deflation where firm-level margin concentration among the leaders held or rose anyway, with the mechanism traced to something other than a non-falling complementary input. *(Source: HBR analysis by BCG economists on AI and margin competition, 2026; historical figures ⚠; NBER code-to-release figure ◆; MIT Sloan CISR digital-colleague survey, n=132, Sept 2025, ◆.)*
