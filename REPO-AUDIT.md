...
**Version:** `2.7.0`  ·  **Commit:** `9c667a0`  ·  **Generated:** 10 Sep 2026 03:24

## Totals

| Metric | Count |
|---|---:|
| **Total tracked files** | **257** |
| **Skills** (`SKILL.md`) | **90** |
...
Version fields are locked in step: `plugin.json` = `marketplace.json` metadata = `marketplace.json` plugins[0] = **2.7.0**.
