...
**Version:** `1.16.0`  ·  **Commit:** `2a902e4`  ·  **Generated:** 30 Aug 2026 14:56
...
Version fields are locked in step: `plugin.json` = `marketplace.json` metadata = `marketplace.json` plugins[0] = **1.16.0**.
