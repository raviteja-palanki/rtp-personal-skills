...
**Version:** `2.2.0`  ·  **Commit:** `c3802c4`  ·  **Generated:** 31 Aug 2026 01:24
...
Version fields are locked in step: `plugin.json` = `marketplace.json` metadata = `marketplace.json` plugins[0] = **2.2.0**.
